...
public class SolutionTest {
	...
	public void test1() {
		...
		assertEquals(expected, s.prettierButSlowSolution(5, A));
		assertEquals(expected, s.prettierButSlowSolution(5, A));
	}
	...
	public void test2() {
		...
		assertEquals(expected, s.prettierButSlowSolution(4, A));
	}
	...
	public void test3() {
		...
		assertEquals(expected, s.prettierButSlowSolution(1, A));
	}
}
